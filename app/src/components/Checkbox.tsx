    ...
    <div className="inline-flex items-center absolute top-5 left-2 w-4 h-4">
      <label className="flex items-center cursor-pointer relative">
        <input
          ...
          className="peer h-5 w-5 cursor-pointer transition-all appearance-none rounded shadow hover:shadow-md border border-slate-300 checked:bg-indigo-600 checked:bg-indigo-600"
        />
