...
export default function Form(props: FormPropsType) {
  ...
  return (
    <form className="space-y-3 border-b border-gray-900/10 pb-3" onSubmit={handleSubmit}>
      <div className="pb-3 mt-5">
        <h2 className="text-base/7 font-semibold text-gray-900">Create new task</h2>
        ...
        <div className="mt-4 grid grid-cols-1 gap-x-6 gap-y-3 sm:grid-cols-6">
          ...
          <div className="col-span-full">
            ...
            <div className="mt-2">
              <textarea name="description" id="description" rows="3" value={description}
                ...
                placeholder="Describe a task" required></textarea>
            </div>
          </div>
        </div>
      </div>
      <div className="flex items-center justify-end">
        <button type="submit"
                className="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Create
        </button>
      </div>
    </form>
  )
