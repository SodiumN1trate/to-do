...
export default function Toast({ message, success }: { message: string | null, success: boolean}) {
  if(message) {
    return (
      <div
        ...
        <div className="flex p-4">
          <div className="shrink-0">
            { success ? <svg className="shrink-0 size-4 text-teal-500 mt-0.5" xmlns="http://www.w3.org/2000/svg" width="16"
            ...
            </svg> : <svg className="shrink-0 size-4 text-red-500 mt-0.5" xmlns="http://www.w3.org/2000/svg" width="16"
                          height="16"
